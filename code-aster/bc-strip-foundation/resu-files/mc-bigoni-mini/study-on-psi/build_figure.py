...
MyCMap=plt.get_cmap("hot").reversed()
...
for root,dirs,files in os.walk(os.getcwd()):
	...
	for f in lFILES:
		...
		ax.plot(tab["INST"],-2.*tab["DY"]/1.e6,c=MyCMapUP[ic],zorder=11)
...
ax.axhline(300.6,c='w',lw=1.,ls='--',zorder=4)
ax.axhline(308.8,c='w',lw=1.,ls='--',zorder=4)
