...
MCBigoniFullParametersInitializer::get()
{
static MCBigoniFullParametersInitializer i;
return i;
}

MCBigoniFullParametersInitializer::MCBigoniFullParametersInitializer()
{
this->theta = 1;
this->epsilon = 1e-14;
...
MCBigoniFullParametersInitializer::readParameters(*this,"MCBigoniFull-parameters.txt");
}

void
MCBigoniFullParametersInitializer::set(const char* const key,
const double v){
using namespace std;
...
tfel::raise("MCBigoniFullParametersInitializer::set: "
...
double
MCBigoniFullParametersInitializer::getDouble(const std::string& n,
const std::string& v)
{
double value;
...
"MCBigoniFullParametersInitializer::getDouble: "
"can't convert '"+v+"' to double for parameter '"+ n+"'");
return value;
}

unsigned short
MCBigoniFullParametersInitializer::getUnsignedShort(const std::string& n,
const std::string& v)
{
...
converter >> value;
tfel::raise_if(!converter||(!converter.eof()),
"MCBigoniFullParametersInitializer::getUnsignedShort: "
"can't convert '"+v+"' to unsigned short for parameter '"+ n+"'");
return value;
}

void
MCBigoniFullParametersInitializer::readParameters(MCBigoniFullParametersInitializer& pi,const char* const fn){
...
tfel::raise_if(c,"MCBigoniFullParametersInitializer::readParameters: "
...
if("theta"==tokens[0]){
pi.theta = MCBigoniFullParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("epsilon"==tokens[0]){
pi.epsilon = MCBigoniFullParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("minimal_time_step_scaling_factor"==tokens[0]){
pi.minimal_time_step_scaling_factor = MCBigoniFullParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("maximal_time_step_scaling_factor"==tokens[0]){
pi.maximal_time_step_scaling_factor = MCBigoniFullParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("numerical_jacobian_epsilon"==tokens[0]){
pi.numerical_jacobian_epsilon = MCBigoniFullParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("iterMax"==tokens[0]){
pi.iterMax = MCBigoniFullParametersInitializer::getUnsignedShort(tokens[0],tokens[1]);
} else {
