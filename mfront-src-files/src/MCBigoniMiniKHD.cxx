...
MCBigoniMiniKHDParametersInitializer::get()
{
static MCBigoniMiniKHDParametersInitializer i;
return i;
}

MCBigoniMiniKHDParametersInitializer::MCBigoniMiniKHDParametersInitializer()
{
this->theta = 1;
this->epsilon = 1e-14;
...
MCBigoniMiniKHDParametersInitializer::readParameters(*this,"MCBigoniMiniKHD-parameters.txt");
}

void
MCBigoniMiniKHDParametersInitializer::set(const char* const key,
const double v){
using namespace std;
...
tfel::raise("MCBigoniMiniKHDParametersInitializer::set: "
...
double
MCBigoniMiniKHDParametersInitializer::getDouble(const std::string& n,
const std::string& v)
{
double value;
...
"MCBigoniMiniKHDParametersInitializer::getDouble: "
"can't convert '"+v+"' to double for parameter '"+ n+"'");
return value;
}

unsigned short
MCBigoniMiniKHDParametersInitializer::getUnsignedShort(const std::string& n,
const std::string& v)
{
...
converter >> value;
tfel::raise_if(!converter||(!converter.eof()),
"MCBigoniMiniKHDParametersInitializer::getUnsignedShort: "
"can't convert '"+v+"' to unsigned short for parameter '"+ n+"'");
return value;
}

void
MCBigoniMiniKHDParametersInitializer::readParameters(MCBigoniMiniKHDParametersInitializer& pi,const char* const fn){
...
tfel::raise_if(c,"MCBigoniMiniKHDParametersInitializer::readParameters: "
...
if("theta"==tokens[0]){
pi.theta = MCBigoniMiniKHDParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("epsilon"==tokens[0]){
pi.epsilon = MCBigoniMiniKHDParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("minimal_time_step_scaling_factor"==tokens[0]){
pi.minimal_time_step_scaling_factor = MCBigoniMiniKHDParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("maximal_time_step_scaling_factor"==tokens[0]){
pi.maximal_time_step_scaling_factor = MCBigoniMiniKHDParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("numerical_jacobian_epsilon"==tokens[0]){
pi.numerical_jacobian_epsilon = MCBigoniMiniKHDParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("iterMax"==tokens[0]){
pi.iterMax = MCBigoniMiniKHDParametersInitializer::getUnsignedShort(tokens[0],tokens[1]);
} else {
