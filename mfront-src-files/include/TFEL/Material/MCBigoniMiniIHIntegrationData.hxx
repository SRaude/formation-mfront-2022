/*!
* \file   TFEL/Material/MCBigoniMiniIHIntegrationData.hxx
* \brief  this file implements the MCBigoniMiniIHIntegrationData class.
*         File generated by tfel version 3.4.0
* \author Simon Raude
* \date   04 / 10 / 2022
 */

#ifndef LIB_TFELMATERIAL_MCBIGONIMINIIH_INTEGRATION_DATA_HXX
#define LIB_TFELMATERIAL_MCBIGONIMINIIH_INTEGRATION_DATA_HXX
...
std::ostream&
 operator <<(std::ostream&,const MCBigoniMiniIHIntegrationData<hypothesis,Type,false>&);

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
class MCBigoniMiniIHIntegrationData<hypothesis,Type,false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const MCBigoniMiniIHIntegrationData&);
...
*/
MCBigoniMiniIHIntegrationData()
{}

/*!
* \brief Copy constructor
*/
MCBigoniMiniIHIntegrationData(const MCBigoniMiniIHIntegrationData& src)
: deto(src.deto),
dt(src.dt),
dT(src.dT)
{}
 ...
 */
MCBigoniMiniIHIntegrationData(const Type* const ASTERdt_,
...
MCBigoniMiniIHIntegrationData&
>::type
scale(const MCBigoniMiniIHBehaviourData<hypothesis,Type,false>&, const Scal time_scaling_factor){
...
*/
MCBigoniMiniIHIntegrationData&
updateDrivingVariables(const MCBigoniMiniIHBehaviourData<hypothesis,Type,false>&){
return *this;
}

}; // end of MCBigoniMiniIHIntegrationDataclass

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
std::ostream&
operator <<(std::ostream& os,const MCBigoniMiniIHIntegrationData<hypothesis,Type,false>& b)
{
os << "Δεᵗᵒ : " << b.deto << '\n';
os << "σ : " << b.sig << '\n';
os << "Δt : " << b.dt << '\n';
...
#endif /* LIB_TFELMATERIAL_MCBIGONIMINIIH_INTEGRATION_DATA_HXX */
