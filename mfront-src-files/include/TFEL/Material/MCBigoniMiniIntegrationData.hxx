/*!
* \file   TFEL/Material/MCBigoniMiniIntegrationData.hxx
* \brief  this file implements the MCBigoniMiniIntegrationData class.
*         File generated by tfel version 3.4.0
* \author Simon Raude
* \date   04 / 10 / 2022
 */

#ifndef LIB_TFELMATERIAL_MCBIGONIMINI_INTEGRATION_DATA_HXX
#define LIB_TFELMATERIAL_MCBIGONIMINI_INTEGRATION_DATA_HXX
...
std::ostream&
 operator <<(std::ostream&,const MCBigoniMiniIntegrationData<hypothesis,Type,false>&);

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
class MCBigoniMiniIntegrationData<hypothesis,Type,false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const MCBigoniMiniIntegrationData&);
...
*/
MCBigoniMiniIntegrationData()
{}

/*!
* \brief Copy constructor
*/
MCBigoniMiniIntegrationData(const MCBigoniMiniIntegrationData& src)
: deto(src.deto),
dt(src.dt),
dT(src.dT)
{}
 ...
 */
MCBigoniMiniIntegrationData(const Type* const ASTERdt_,
...
MCBigoniMiniIntegrationData&
>::type
scale(const MCBigoniMiniBehaviourData<hypothesis,Type,false>&, const Scal time_scaling_factor){
...
*/
MCBigoniMiniIntegrationData&
updateDrivingVariables(const MCBigoniMiniBehaviourData<hypothesis,Type,false>&){
return *this;
}

}; // end of MCBigoniMiniIntegrationDataclass

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
std::ostream&
operator <<(std::ostream& os,const MCBigoniMiniIntegrationData<hypothesis,Type,false>& b)
{
os << "Δεᵗᵒ : " << b.deto << '\n';
os << "σ : " << b.sig << '\n';
os << "Δt : " << b.dt << '\n';
...
#endif /* LIB_TFELMATERIAL_MCBIGONIMINI_INTEGRATION_DATA_HXX */
