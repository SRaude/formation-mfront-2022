/*!
* \file   TFEL/Material/MCBigoniMiniKHDIntegrationData.hxx
* \brief  this file implements the MCBigoniMiniKHDIntegrationData class.
*         File generated by tfel version 3.4.0
* \author Simon Raude
* \date   08 / 10 / 2022
 */

#ifndef LIB_TFELMATERIAL_MCBIGONIMINIKHD_INTEGRATION_DATA_HXX
#define LIB_TFELMATERIAL_MCBIGONIMINIKHD_INTEGRATION_DATA_HXX
...
std::ostream&
 operator <<(std::ostream&,const MCBigoniMiniKHDIntegrationData<hypothesis,Type,false>&);

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
class MCBigoniMiniKHDIntegrationData<hypothesis,Type,false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const MCBigoniMiniKHDIntegrationData&);
...
*/
MCBigoniMiniKHDIntegrationData()
{}

/*!
* \brief Copy constructor
*/
MCBigoniMiniKHDIntegrationData(const MCBigoniMiniKHDIntegrationData& src)
: deto(src.deto),
dt(src.dt),
dT(src.dT)
{}
 ...
 */
MCBigoniMiniKHDIntegrationData(const Type* const ASTERdt_,
...
MCBigoniMiniKHDIntegrationData&
>::type
scale(const MCBigoniMiniKHDBehaviourData<hypothesis,Type,false>&, const Scal time_scaling_factor){
...
*/
MCBigoniMiniKHDIntegrationData&
updateDrivingVariables(const MCBigoniMiniKHDBehaviourData<hypothesis,Type,false>&){
return *this;
}

}; // end of MCBigoniMiniKHDIntegrationDataclass

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
std::ostream&
operator <<(std::ostream& os,const MCBigoniMiniKHDIntegrationData<hypothesis,Type,false>& b)
{
os << "Δεᵗᵒ : " << b.deto << '\n';
os << "σ : " << b.sig << '\n';
os << "Δt : " << b.dt << '\n';
...
#endif /* LIB_TFELMATERIAL_MCBIGONIMINIKHD_INTEGRATION_DATA_HXX */
