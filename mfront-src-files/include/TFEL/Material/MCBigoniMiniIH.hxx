...
computePartialJacobianInvert(const tfel::math::TinyPermutation<2+StensorSize>& jacobian_permutation, tfel::math::derivative_type<StrainStensor, StrainStensor>& partial_jacobian_eel,
tfel::math::derivative_type<real, StrainStensor>& partial_jacobian_lam,
tfel::math::derivative_type<real, StrainStensor>& partial_jacobian_gap)
{
using namespace tfel::math;
for(unsigned short idx=0;idx!=StensorSize;++idx){
tvector<2+StensorSize,real> vect_e(real(0));
...
using namespace tfel::math;
using std::vector;
#line 150 "MCBigoniMiniIH.mfront"
...
using namespace std;
using namespace tfel::math;
#line 230 "MCBigoniMiniIH.mfront"
this->inst+=this->dt;
#line 231 "MCBigoniMiniIH.mfront"
this->niter=iter;
...
#line 160 "MCBigoniMiniIH.mfront"
if ((this->b)){
#line 163 "MCBigoniMiniIH.mfront"
...
#line 188 "MCBigoniMiniIH.mfront"
...
#line 191 "MCBigoniMiniIH.mfront"
...
#line 198 "MCBigoniMiniIH.mfront"
...
#line 217 "MCBigoniMiniIH.mfront"
else {
#line 219 "MCBigoniMiniIH.mfront"
...
#line 246 "MCBigoniMiniIH.mfront"
if((smt==ELASTIC)||(smt==SECANTOPERATOR)) {
#line 247 "MCBigoniMiniIH.mfront"
