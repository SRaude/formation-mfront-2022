/*!
* \file   include/MFront/Aster/asterMCBigoniMiniKHD.hxx
* \brief  This file declares the aster interface for the MCBigoniMiniKHD behaviour law
* \author Simon Raude
* \date   08 / 10 / 2022
*/

#ifndef LIB_ASTER_MCBIGONIMINIKHD_HXX
#define LIB_ASTER_MCBIGONIMINIKHD_HXX
...
struct AsterTraits<tfel::material::MCBigoniMiniKHD<H,Type,false> >
{
//! behaviour type
...
astermcbigoniminikhd_setOutOfBoundsPolicy(const int);

MFRONT_SHAREDOBJ int
astermcbigoniminikhd_setParameter(const char *const,const double);

MFRONT_SHAREDOBJ int
astermcbigoniminikhd_setUnsignedShortParameter(const char *const,const unsigned short);

MFRONT_SHAREDOBJ char *astermcbigoniminikhd_getIntegrationErrorMessage();
...
#endif /* LIB_ASTER_MCBIGONIMINIKHD_HXX */
