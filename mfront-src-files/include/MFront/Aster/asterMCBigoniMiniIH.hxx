...
#define LIB_ASTER_MCBIGONIMINIIH_HXX
...
struct AsterTraits<tfel::material::MCBigoniMiniIH<H,Type,false> >
{
//! behaviour type
...
astermcbigoniminiih_setOutOfBoundsPolicy(const int);

MFRONT_SHAREDOBJ int
astermcbigoniminiih_setParameter(const char *const,const double);

MFRONT_SHAREDOBJ int
astermcbigoniminiih_setUnsignedShortParameter(const char *const,const unsigned short);

MFRONT_SHAREDOBJ char *astermcbigoniminiih_getIntegrationErrorMessage();
...
#endif /* LIB_ASTER_MCBIGONIMINIIH_HXX */
