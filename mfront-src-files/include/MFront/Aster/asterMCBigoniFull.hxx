...
#define LIB_ASTER_MCBIGONIFULL_HXX
...
struct AsterTraits<tfel::material::MCBigoniFull<H,Type,false> >
{
//! behaviour type
...
astermcbigonifull_setOutOfBoundsPolicy(const int);

MFRONT_SHAREDOBJ int
astermcbigonifull_setParameter(const char *const,const double);

MFRONT_SHAREDOBJ int
astermcbigonifull_setUnsignedShortParameter(const char *const,const unsigned short);

MFRONT_SHAREDOBJ char *astermcbigonifull_getIntegrationErrorMessage();
...
#endif /* LIB_ASTER_MCBIGONIFULL_HXX */
