...
RootToOutputFiles="/home/simon/dev/formation-mfront-2022/advanced-mtests/mc-bigoni-full/triax_output_files"
...
SensiDicPara["PiShapeCoef"]={"list":np.linspace(0.,.995,8),"label":r"$\gamma$ (-)","scale":1.}
