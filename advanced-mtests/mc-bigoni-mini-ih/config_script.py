...
DefaultDicPara["HardeningCoef"]=0.
...
RootToOutputFiles="/home/simon/dev/formation-mfront-2022/advanced-mtests/mc-bigoni-mini-ih/triax_output_files"
...
SensiDicPara["HardeningCoef"]={"list":np.logspace(-2,1,8),"label":r"$h_C$ (-)","scale":1.}
